...
while(True):
    ...
    thresholded_g = thresholdNew(Green, 20, 40)  #<-- greenness thresholds
    thresholded_b = thresholdNew(Blue, 40, 60)   #<-- blueness thresholds
    ...
    thresholded_g1 = thresholdNew(Green, 90, 120)  #<-- greenness thresholds
    thresholded_b1 = thresholdNew(Blue, 140, 170)   #<-- blueness thresholds

    common1 = cv2.bitwise_and(thresholded_r1, cv2.bitwise_and(thresholded_g1, thresholded_b1))
    common_contours1 = findContour(common1, 0)
